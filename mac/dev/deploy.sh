#!/bin/sh
# Copy the built dylib, the native launcher and the Steam launch wrapper to
...
cp native/build/steam_launch "$DEST/steam_launch"
cp steam_launch.sh "$DEST/steam_launch.sh"
chmod +x "$DEST/steam_launch" "$DEST/steam_launch.sh"
echo "deployed to $DEST"
echo "Steam launch options: \"$DEST/steam_launch\" %command%"
